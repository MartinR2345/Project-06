...
// For the second if statement, I grabbed the id name of "correct3" from the DOM with the document.getElementById() and I used the .checked property basically to assign true without casting. This will checked as the right answer then access the innerHTML of my "number_correct3" and display whether the user is right or wrong 
// I grabbed the id name of "after_submit1" from the DOM with the document.getElementById() then access the style visibility and assigned it to the "visible". This will make my element visible or seen.
// I grabbed the id name of "after_submit2" from the DOM with the document.getElementById() then access the style visibility and assigned it to the "visible". This will make my element visible or seen.
// I grabbed the id name of "after_submit3" from the DOM with the document.getElementById() then access the style visibility and assigned it to the "visible". This will make my element visible or seen.
...
// I will select the id name of "number_correct1" from the DOM with the document.getElementById() and accessed the inner HTML content of that element and assigned it to an empty strings. This will actually reset the data.
// I will select the id name of "number_correct2" from the DOM with the document.getElementById() and accessed the inner HTML content of that element and assigned it to an empty strings. This will actually reset the data.
// I will select the id name of "number_correct3" from the DOM with the document.getElementById() and accessed the inner HTML content of that element and assigned it to an empty strings. This will actually reset the data.
